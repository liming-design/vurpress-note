...
import GlobalLayout from "/root/czs/code/vuepress-starter/node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-629d69f7").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-23a29a78").then(next)
    },
  },
  {
    name: "v-36871124",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-36871124").then(next)
    },
  },
  {
    name: "v-b1564aac",
